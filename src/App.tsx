                                                    ...
                                                    <tr key={transaction.id} className="border-b border-border hover:bg-muted/50 transition-colors group">
                                                        ...
                                                        <td className="p-2 w-24">
                                                            <Input
                                                                ...
                                                                className="border-none shadow-none text-right font-serif focus-visible:ring-0"
                                                                placeholder="0"
                                                            />
                                                        </td>
                                                        <td className="p-2 w-12 border-r border-border">
                                                            <Input
                                                                type="number"
                                                                ...
                                                                className="border-none shadow-none text-center text-xs opacity-70 focus-visible:ring-0"
                                                                placeholder="00"
                                                            />
                                                        </td>
                                                        {/* Credit Split */}
